...
export function deriveItemsFromLegacySettings(
  ...
  if (settings.ui.footer.showCWD === false) remove(items, 'workspace');
  if (settings.ui.footer.showSandboxStatus === false) remove(items, 'sandbox');
  if (settings.ui.footer.showModelInfo === false) {
